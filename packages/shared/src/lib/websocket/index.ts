...
export enum WebsocketClientEvent {
    ...
    FLOW_COMMENT_CREATED = 'FLOW_COMMENT_CREATED',
    FLOW_COMMENT_CHANGED = 'FLOW_COMMENT_CHANGED',
    FLOW_COMMENT_DELETED = 'FLOW_COMMENT_DELETED',
    FLOW_COMMENT_MENTION = 'FLOW_COMMENT_MENTION',
    PROJECT_MEMBERS_CHANGED = 'PROJECT_MEMBERS_CHANGED',
}
